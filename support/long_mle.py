...
4. may want to check output against some package specialised in MLE, eg 
...
5. Next thing is probably would be programming Kalman filter and comparing it with other 
